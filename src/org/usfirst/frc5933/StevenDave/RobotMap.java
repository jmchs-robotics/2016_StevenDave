...
public class RobotMap {
    ...
    public static AnalogInput sensorsRearUltrasonic;
    public static SpeedController ballGrabberSubsystemSpindleMotor;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public static Helmsman helmsman;
    ...
    public static void init() {
        ...
        sensorsRearUltrasonic = new AnalogInput(4);
        LiveWindow.addSensor("Sensors", "RearUltrasonic", sensorsRearUltrasonic);
