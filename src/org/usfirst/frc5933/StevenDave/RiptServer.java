...
public class RiptServer {
    ...
    private static boolean run_ = true;
    private static String cameraName_ = kDefaultCameraName;
    ...
    public static RiptServer getInstance() {
        run_ = true;
        if (server == null) {
            server = new RiptServer();
        }
        return server;
    }
    ...
    public void setImage(Image image) {
        ...
        RawData data = NIVision.imaqFlatten(image, NIVision.FlattenType.FLATTEN_IMAGE,
     ...
     * any vision processing on the roboRIO. {@link #setImage} shouldn't be
     * called after this is called. This overload calles
     ...
     * the correct mode, or set it directory on a camera and call the
     * appropriate autoCapture method $
     * 
     * @param size
     *            The size to use
     */
