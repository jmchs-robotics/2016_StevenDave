 ...
 *
 */
public class ToggleForwardSpindle extends Command {
	private double secondsToStayOn_ = 0;
	private double startTimestamp_ = 0;
	
	public ToggleForwardSpindle(double seconds) {
	...
	protected void initialize() {
		...
		Robot.ballGrabberSubsystem.toggleForward();
	}
